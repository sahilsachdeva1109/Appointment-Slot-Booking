...
A Spring Boot project with MySQL database to manage users, slots, and appointments.  
This project demonstrates a full backend flow for booking, cancelling, and managing appointments with proper entity relationships, services, and RESTful APIs.
